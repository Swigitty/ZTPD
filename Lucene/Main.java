...
//      w.addDocument(buildDoc("Dummy and yummy title", "9780525656161"));
        ...
        // -- Zadanie-7
            String querystr = "*:*";
            String querystr = "dummy"; // a) 1
            String querystr = "and"; // b) 1
        */

        /* 
        // -- Zadanie-9
            String querystr = "dummy"; // a) 2
            String querystr = "and"; // b) 0
        */

        /* 
        // -- Zadanie-12
            String querystr = "isbn:9780062316097"; // a) 1 
            String querystr = "urodzić"; // b) 2 
            String querystr = "rodzić"; // c) 0 
            String querystr = "ro*"; // d) 2 
            String querystr = "ponieważ"; // e) 0 
            String querystr = "Lucyna AND akcja"; // f) 1 
            String querystr = "akcja NOT Lucyna"; // g) 1 
            String querystr = "\"naturalnie morderca\"~2"; // h) 1 
            String querystr = "\"naturalnie morderca\"~1"; // i) 1 
            String querystr = "\"naturalnie morderca\"~0"; // j) 0 
            String querystr = "naturalne"; // k) 1 
        */
            String querystr = "naturalne~"; // l) 1 
